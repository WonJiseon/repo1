 ...
 * => 인터넷 상의 특정 컴퓨터에 저장된 자원(파일) 가리키는 식별자/주소 이다.
 * => 표기법
 * 1) URN
 ...
 * => URL 인코딩 예) 'A가' ---> A%EA%B0%80 (UTF-8 문자표의 코드 값으로 인코딩)
